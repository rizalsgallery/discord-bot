...
class TicketSystem(commands.Cog):
    ...
    async def claim_ticket(self, interaction, ticket_id, view, button):
        ...
        # Determine which support role to check based on ticket type
        ...
        if not support_role or support_role not in interaction.user.roles:
            return await interaction.response.send_message("❌ Only support team can claim tickets.", ephemeral=True)
